...
class Layout(QGridLayout):
    ...
    def create_common_elements(self):
        ...
        self.exit_button.setFixedSize(self.button_width * self.column_width, 
                                      self.widget_height * self.row_height)
        self.exit_button.clicked.connect(self.exit_button_clicked)
        
        self.main_button = QPushButton("Main")
        self.main_button.setFixedSize(self.button_width * self.column_width, 
                                      self.widget_height * self.row_height)
        self.main_button.clicked.connect(self.main_button_clicked)
        
        self.monitor_button = QPushButton("Monitor")
        self.monitor_button.setFixedSize(self.button_width * self.column_width, 
                                      self.widget_height * self.row_height)
        self.monitor_button.clicked.connect(self.monitor_button_clicked)
        
        self.tasks_button = QPushButton("Tasks")
        self.tasks_button.setFixedSize(self.button_width * self.column_width, 
                                      self.widget_height * self.row_height)
        self.tasks_button.clicked.connect(self.tasks_button_clicked)
        
        self.data_button = QPushButton("Data")
        self.data_button.setFixedSize(self.button_width * self.column_width, 
                                      self.widget_height * self.row_height)
        self.data_button.clicked.connect(self.data_button_clicked)
        
        self.settings_button = QPushButton("Settings")
        self.settings_button.setFixedSize(self.button_width * self.column_width, 
                                      self.widget_height * self.row_height)
        self.settings_button.clicked.connect(self.settings_button_clicked)

        self.addWidget(self.main_button, self.top_row, self.first_menu_button, 
                       self.widget_height, self.button_width)
        self.addWidget(self.monitor_button, self.top_row, self.first_menu_button + self.button_width, 
                       self.widget_height, self.button_width)
        self.addWidget(self.tasks_button, self.top_row, self.first_menu_button + 2 * self.button_width, 
                       self.widget_height, self.button_width)
        self.addWidget(self.data_button, self.top_row, self.first_menu_button + 3 * self.button_width, 
                       self.widget_height, self.button_width)
        self.addWidget(self.settings_button, self.top_row, self.first_menu_button + 4 * self.button_width, 
                       self.widget_height, self.button_width)
        self.addWidget(self.exit_button, self.top_row, self.last_menu_button, 
                       self.widget_height, self.button_width)
        
    def exit_button_clicked(self):
        reply = QMessageBox.question(self.window, 'Exit', 
