...
class Gui:
    def __init__(self, app):
        ...
        self.primary_width = availableGeometry.width() - 8 # 8 pixels for the border
        self.primary_height = availableGeometry.height() - 30 # 30 pixels for the top menu bar
        ...
        if settings.get('USE_SCREEN') != 'No Screen':
            ...
            self.behaviour_window = BehaviourWindow(app, self.secondary_width, self.secondary_height)
